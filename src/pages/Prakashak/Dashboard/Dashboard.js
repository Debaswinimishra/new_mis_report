    ...
    useEffect(() => {
      if (chartRef && chartRef.current) {
        ...
        const smartphoneBoysData = [
          231, 1002, 1728, 1960, 2845, 3232, 3181, 3598, 3536, 4380, 8721,
        ];
        const smartphoneGirlsData = [
          238, 1019, 1746, 1973, 2853, 3226, 3193, 3594, 3549, 4322, 7883,
        ];

        const nonSmartphoneBoysData = [
          93, 328, 533, 637, 1195, 1409, 1371, 1523, 1503, 1931, 2804,
        ];
        const nonSmartphoneGirlsData = [
          103, 264, 543, 612, 1203, 1407, 1365, 1535, 1505, 1956, 2989,
        ];

        const totalBoysData = [
          324, 1330, 2261, 2597, 4040, 4641, 4552, 5121, 5039, 6306, 11525,
        ];
        const totalGirlsData = [
          341, 1283, 2289, 2585, 4056, 4633, 4558, 5129, 5054, 6283, 10872,
        ];
