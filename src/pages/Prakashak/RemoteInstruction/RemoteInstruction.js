...
const dataJson = [
  {
    month: 1,
    week: 4,
    new_remote_instructions_users: 396,
    new_active_students: 196,
    new_activated_students: 196,
