...
const dataJson = [
  {
    month: 1,
    week: 1,
    new_remote_instructions_users: 23,
    new_active_students: 56,
    new_activated_students: 34,
    total_sms_scheduled: 56,
    total_sms_delivered: 56,
    total_calls_made: 34,
    total_calls_received: 56,
    total_calls_mins: 34,
    total_ivrs_calls_made: 456,
    total_ivrs_calls_mins: 34,
  },
  {
    month: 1,
    week: 2,
